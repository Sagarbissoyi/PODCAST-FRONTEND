...
const Header = () => {
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      const res = await axios.get("https://podcast-backend-jgm2.onrender.com/api/v1/user-details", {
  ...
  const LogoutHandler = async()=> {
    const res=  await axios.post("https://podcast-backend-jgm2.onrender.com/api/v1/logout",{
      withCredentials : true,
